...
= 1.0.9 =
* Removed base_url support for windows servers.
...
* Improved the behavior of the image managing tab in the Edit gallery view
...
= 1.0.2 =
* Fixed the draft-galleries-bug

= 1.0.1 =
* Added some missing javascript files and images
